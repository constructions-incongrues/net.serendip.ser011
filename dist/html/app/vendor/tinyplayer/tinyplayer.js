      ...
      createSongPlayer: function(title) {
        return $("<div>")
          ...
          .append($("<div>").addClass("song-main-info")
            .append($('<div class="icon fa fa-play">'))
            .append($('<div class="icon fa fa-pause">').hide())
            .append($('<div class="icon fa fa-stop">'))
            .append($('<div class="song-title">').html(title + "  "))
            .append($('<div>').addClass("song-timer"))
            .append($('<div class="icon fa fa-volume-up">')))
      ...
      _createHowlForPlayer: function(player, song) {
        ...
        return new Howl({
          ...
          onend: function() {
            ...
            // Play next song
            $(song_elem[0].nextElementSibling.nextElementSibling).find(".fa-play").click();
          },
          onpause: function() {
            var self = this;
            song_elem.find(".fa-pause").hide();
